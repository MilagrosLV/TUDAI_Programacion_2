...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Planta p2 = new Planta("Lavandula angustifolia", "Magnoliophyta", "Lamiaceae", "Magnoliopsida", new ArrayList<>(ArraysList("Lavanda")), 7, 2, true);
        ...
        Filtro f11 = new FiltroNombreCientificoIncluye("angustifolia");
        ...
        System.out.println("c) Plantas cuya clasificación sea 'Magnoliophyta': " + imprimir(v.plantasCriterio(f3)));
        ...
        System.out.println("g) Cualquier combinación lógica de las formas anteriores: " + imprimir(v.plantasCriterio(fgg)));
