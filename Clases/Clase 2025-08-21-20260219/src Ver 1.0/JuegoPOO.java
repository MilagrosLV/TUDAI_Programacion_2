...
public class JuegoPOO {
	...
	public JuegoPOO(Jugador j1, Jugador j2, int canLados) {
		...
		jug1 = j1;
		jug2 = j2;
		dado1 = new Dado(canLados);
		dado2 = new Dado(canLados);
	...
	public JuegoPOO(Jugador j1, Jugador j2, int canLados, int canLados2) {
		
		jug1 = j1;
		jug2 = j2;
		dado1 = new Dado(canLados);
		dado2 = new Dado(canLados2);
		menorValor = ((canLados +canLados2)/2 )+1;
	}
	...
	public static void main(String[] args) {
		...
		JuegoPOO juegoDados= new JuegoPOO(20,j1,j2,8);
